...
const PaymentExpansion: React.FC = () => {
  ...
  const [priority, setPriority] = useState<
    "speed" | "balanced" | "compliance-first"
  >("balanced");
    ...
    <div className="page-container">
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            KI-Analyse erfolgt in Echtzeit via GPT-4o-mini. Keine dauerhafte
            Speicherung; Daten werden nur im RAM verarbeitet. OpenAI-API
            verarbeitet Daten gemäß deren Datenschutzrichtlinien.
          </div>
        </div>
      </motion.div>
        ...
        >
            ...
            >
              {regions.map((region) => (
                <motion.div
                  ...
                  whileTap={{ scale: 0.97 }}
                  onClick={() => setTargetRegion(region.value as any)}
                  style={{
                    padding: "14px",
                    background:
                      targetRegion === region.value
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => setCurrentMarkets(Number(e.target.value))}
              className="form-input"
              placeholder="3"
            />
          </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {formatCurrency(plan.revenueProjection.likely)}
                </div>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  {formatCurrency(plan.revenueProjection.best)}
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
              ...
              {plan.timeline.map((p, idx) => (
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontSize: "13px", color: "#aeb8ff" }}>
                      {p.durationWeeks} Wochen
                    </span>
                  </div>
                  <div
                    style={{
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {plan.paymentStack.psp.join(", ") || "N/A"}
                </div>
              </div>
              <div
                style={{
              ...
              >
                ...
                <div
                  style={{ fontSize: "13px", color: "rgba(255,255,255,0.85)" }}
                >
                  {plan.paymentStack.paymentMethods.join(", ") || "N/A"}
                </div>
              </div>
              <div
                style={{
              ...
              >
                ...
                <div
                  style={{ fontSize: "13px", color: "rgba(255,255,255,0.85)" }}
                >
                  {plan.paymentStack.fraud || "Nicht angegeben"}
                </div>
              </div>
            </div>
          </motion.div>
            ...
            >
              ...
              >
                ...
                <div
                  style={{ fontSize: "13px", color: "rgba(255,255,255,0.85)" }}
                >
                  {plan.localization.currencies.join(", ") || "N/A"}
                </div>
              </div>
              <div
                style={{
              ...
              >
                ...
                <div
                  style={{ fontSize: "13px", color: "rgba(255,255,255,0.85)" }}
                >
                  {plan.localization.languages.join(", ") || "N/A"}
                </div>
              </div>
              <div
                style={{
              ...
              >
                ...
                <div
                  style={{ fontSize: "13px", color: "rgba(255,255,255,0.85)" }}
                >
                  {plan.localization.tax || "Nicht angegeben"}
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              {plan.complianceChecklist.length === 0 && (
                <div
                  style={{ color: "rgba(255,255,255,0.6)", fontSize: "13px" }}
                >
                  Keine Compliance-Punkte
                </div>
              )}
            </div>
          </motion.div>
