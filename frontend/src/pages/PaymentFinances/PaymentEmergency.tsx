...
const PaymentEmergency: React.FC = () => {
  ...
  const [analysis, setAnalysis] = useState<EmergencyAnalysisResult | null>(
    null
  );
    ...
    <div className="page-container">
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            KI-Notfall-Analyse erfolgt in Echtzeit via GPT-4o-mini. Keine
            dauerhafte Speicherung von Incident-Daten. Analysedaten werden nur
            temporär im RAM verarbeitet. OpenAI-API verarbeitet Daten gemäß
      ...
      >
        ...
        >
          ...
          >
            <span>💬</span>
            <span>
              <strong>Slack:</strong> SLACK_EMERGENCY_WEBHOOK
            </span>
          </div>
          <div
            style={{
          ...
          >
            <span>📧</span>
            <span>
              <strong>Email:</strong> EMERGENCY_ALERT_EMAIL
            </span>
          </div>
          <div
            style={{
          ...
          >
            <span>📟</span>
            <span>
              <strong>PagerDuty:</strong> PAGERDUTY_INTEGRATION_KEY
            </span>
          </div>
          <div
            style={{
          ...
          >
            <span>📋</span>
            <span>
              <strong>Console:</strong> Immer aktiv
            </span>
          </div>
        </div>
        <div
        ...
        >
          Hinweis: Notfälle werden automatisch an alle konfigurierten Kanäle
          gemeldet. P0/P1 Incidents lösen PagerDuty-Alarm aus.
        </div>
      </motion.div>
        ...
        >
          ...
          <div style={{ marginTop: "20px" }}>
            <LoadingButton
              ...
              loading={loading}
              loadingText="KI analysiert..."
            >
              🤖 KI-Notfall-Analyse starten
            </LoadingButton>
          </div>
        </motion.div>
                  ...
                  style={{
                    background:
                      analysis.severity === "P0"
                        ? "linear-gradient(135deg, rgba(255,59,48,0.2), rgba(255,149,0,0.2))"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {formatNumber(analysis.estimatedImpact.customersFacing)}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    {formatCurrency(analysis.estimatedImpact.revenueAtRisk)}
                  </div>
                </div>
                <div
                  style={{
                    background: analysis.estimatedImpact.slaViolation
                      ? "rgba(255,59,48,0.1)"
                      : "rgba(52,199,89,0.1)",
                    border: `1px solid ${analysis.estimatedImpact.slaViolation ? "rgba(255,59,48,0.5)" : "rgba(52,199,89,0.5)"}`,
                    borderRadius: "12px",
                    padding: "16px",
                    textAlign: "center",
                  }}
                >
                  ...
                  <div
                    style={{
                      fontSize: "20px",
                      fontWeight: "bold",
                      color: analysis.estimatedImpact.slaViolation
                        ? "#ff3b30"
                        : "#34c759",
                    }}
                  >
                    {analysis.estimatedImpact.slaViolation
                      ? "❌ Verletzt"
                      : "✅ OK"}
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    {analysis.estimatedImpact.uptimeImpact}
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {analysis.communicationTemplate.internal}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    {analysis.communicationTemplate.customer}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    {analysis.communicationTemplate.stakeholder}
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              >
                {analysis.slaDeadline && (
                  ...
                  >
                    ...
                    >
                      {formatDateTime(new Date(analysis.slaDeadline))}
                    </div>
                  </div>
                )}
                {analysis.runbookUrl && (
