...
const ContextGenerator: React.FC = () => {
  ...
  const [generatedContext, setGeneratedContext] =
    useState<ContextGenerationResult | null>(null);
  ...
  const detailLevels = [
    ...
    { value: "medium", label: "Mittel", icon: "📄", description: "Ausgewogen" },
    {
      ...
      label: "Detailliert",
      icon: "📋",
      description: "Umfassend",
    },
    {
      value: "expert",
      label: "Experte",
      icon: "🎓",
      description: "Tiefgehend",
    },
  ];
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (!response.success || !response.data) {
        throw new Error(
          response.error || "Kontext konnte nicht generiert werden"
        );
      }
            ...
            >
              {detailLevels.map((level) => (
                ...
                >
                  ...
                  <div
                    style={{ fontSize: "9px", opacity: 0.7, color: "white" }}
                  >
                    {level.description}
                  </div>
                </motion.div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {Math.round(
                        (generatedContext.metadata?.confidence || 0) * 100
                      )}
                      %
                    </div>
                    <div
                    ...
                    >
                      {generatedContext.metadata?.model}
                    </div>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      {generatedContext.metadata?.generatedAt
                        ? formatDateTime(
                            new Date(generatedContext.metadata.generatedAt)
                          )
                        : "—"}
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {(generatedContext.keyPoints || []).length === 0 && (
                        <li>Keine Kernpunkte geliefert</li>
                      )}
                    </ul>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      ...
                      {(generatedContext.guardrails || []).length === 0 && (
                        <li>Keine Guardrails geliefert</li>
                      )}
                    </ul>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <motion.button
                      onClick={() =>
                        copyToClipboard(generatedContext.promptTemplate)
                      }
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      style={{
                  ...
                  >
                    {generatedContext.promptTemplate ||
