...
- Future consideration: AES-256 encryption for systemPrompts (v1.0.0?)
...
- `README.md` → v1.0.0 badge
- `README_EN.md` → v1.0.0 badge
- `package.json` → v1.0.0 version
- `CHANGELOG.md` → v1.0.0 entry with all changes
...
Version 1.0.0 delivers **commercial-grade security** for A.R.I. specializations:
