...
- Future consideration: AES-256 encryption for systemPrompts (v7.4.0?)
...
- `README.md` → v7.3.0 badge
- `README_EN.md` → v7.3.0 badge
- `package.json` → v7.3.0 version
- `CHANGELOG.md` → v7.3.0 entry with all changes
- `.gitignore` → wp-config*.php protection

### New Files

- `RELEASE_NOTES_v7.3.0.md` (this file)
...
For questions or issues related to v7.3.0:
...
Version 7.3.0 delivers **commercial-grade security** for A.R.I. specializations:
...
**Migration**: Drop-in compatible with v7.2.0, no breaking changes.
