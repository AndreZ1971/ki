# A.R.I. Deployment Guide v1.0.0

**Version**: 1.0.0 | **Last Updated**: February 12, 2026  
...
docker build -t ari-frontend:1.0.0 -f frontend/Dockerfile.prod .

# Build backend image
docker build -t ari-backend:1.0.0 -f backend/Dockerfile.prod .

# Run containers
docker run -d -p 3000:3000 --name ari-frontend ari-frontend:1.0.0
docker run -d -p 3001:3001 --name ari-backend ari-backend:1.0.0
```
